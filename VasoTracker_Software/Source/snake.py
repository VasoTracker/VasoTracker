# Snake game.
# Courtesy of https://github.com/RageBill/tkinter-snake/blob/master/python_snake.py
...
class Application:
  ...
  def spawn_food(self):
    ...
    chars = ['B','l','a','d','d','e','r']
    num = self.count % len(chars)
    character = 's' #chars[num]
  ...
  def game_over(self):
    ...
    self.canvas.create_text(round(width/2), round(height/2), text="Game Over! Your score is: %d.\nYou did not beat our high score.\nTry again." %score)
